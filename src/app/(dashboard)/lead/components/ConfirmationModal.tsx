    ...
    switch (type) {
      case "save":
        return {
          ...
          bg: "bg-green-600",
          defaultTitle: "Confirm to Save Change?", 
          defaultDesc: "Press confirm if you are sure",
        };
      case "delete":
        return {
          icon: <Trash2 size={32} color="white" />,
          bg: "bg-red-600",
          defaultTitle: "Delete Lead?",
          defaultDesc: "Press confirm if you are sure",
        };
      case "won":
        return {
          icon: <FileCheck size={32} color="white" />,
          bg: "bg-green-600",
          defaultTitle: "Confirm to Mark as Won?",
          defaultDesc: "Press confirm if you are sure",
        };
      case "lost":
        return {
          icon: <FileCheck size={32} color="white" />,
          bg: "bg-green-600",
          defaultTitle: "Confirm to Mark as Lost?",
          defaultDesc: "Press confirm if you are sure",
        };
      default:
        return null;
  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl w-[360px] text-center shadow-lg transition-colors">
        ...
        {/* === Title & Description === */}
        {/* Gunakan 'title' dari props jika ada, jika tidak pakai default */}
